...
Fresnel.prototype.processTasks = function() {
    setInterval(this._bind(this.bufferTasks), exports.BUFFER_INTERVAL);
    setInterval(this._bind(this.runBufferedTasks), exports.EXECUTE_INTERVAL);
}
...
Fresnel.prototype.runBufferedTasks = function() {
    console.log("Running buffered tasks...");
