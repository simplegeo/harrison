...
Fresnel.prototype.acceptTasks = function() {
    // TODO change HTTP_PORT to DEFAULT_HTTP_PORT and accept a custom port as
    // a param
...
Fresnel.prototype.expirePendingTasks = function(callback) {
    ...
    self._getPendingTasks(0, function(tasks) {
...
Fresnel.prototype.getErroredOutTasks = function(count, callback) {
    this._getClient().zrevrange(this._namespace("error"), 0, count - 1, "WITHSCORES", x(function(reply) {
        var tasks = [];
 ...
 */
Fresnel.prototype.getFailedTasks = function(count, callback) {
    this._getClient().zrevrange(this._namespace("failed"), 0, count - 1, "WITHSCORES", x(function(reply) {
        var tasks = [];
 ...
 */
Fresnel.prototype.getPublicDefinition = function(task) {
    return {
        "class": task['class'],
        "args": task.args
    };
 ...
 */
Fresnel.prototype.getFailCount = function(callback) {
 ...
 */
Fresnel.prototype._createHttpServer = function() {
    var self = this;
...
Fresnel.prototype._getQueuedTasks = function(count, callback) {
    this._getClient().zrevrange(this._namespace("queue"), 0, count - 1, "WITHSCORES", x(function(reply) {
        var tasks = [];
 ...
 */
Fresnel.prototype._getPendingTasks = function(count, callback) {
    this._getClient().zrange(this._namespace("pending"), 0, count - 1, "WITHSCORES", x(function(reply) {
        var tasks = [];
